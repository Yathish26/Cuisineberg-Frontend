        ...
        <>
            ...
            <div className="bg-white text-blue-900 min-h-screen">
                <div className="container mx-auto px-4 py-8 max-w-4xl">
                    ...
                    <p className="text-center mb-8 text-blue-700">Effective Date: June 7, 2025</p>
                    ...
                    <section className="mb-10">
                        ...
                        {infoCollection.map(({ title, items }) => (
                            <div key={title} className="mb-6">
                                <h3 className="text-xl font-medium text-blue-800 mb-2">{title}</h3>
                    ...
                    <section className="mb-10">
                        ...
                        <p className="mb-4">We do not sell your data to third parties. We may share data:</p>
                        <ul className="list-disc pl-6 text-blue-800">
                    ...
                    <section className="mb-10">
                        ...
                        <p>However, no system is 100% secure. Please maintain strong passwords and good security practices.</p>
                    </section>
                    ...
                    <section className="mb-10">
                        ...
                        <p>To exercise your rights, email us at: <a href="mailto:cuisineberg@gmail.com" className="text-blue-600 underline">cuisineberg@gmail.com</a></p>
                    </section>

                    <section className="mb-10">
                        <h2 className="text-2xl font-semibold mb-4">7. Children’s Privacy</h2>
                        <p>
                            Cuisineberg is not intended for users under 18. We do not knowingly collect data
                            from minors.
                        </p>
                    </section>
                    ...
                    <section className="mb-10">
                        ...
                        <p>
                            Our platform primarily serves India. If accessed internationally, data may be stored
                            in India or associated cloud regions.
                        </p>
                    </section>
                    ...
                    <section className="mb-10">
                        ...
                        <p className="leading-relaxed">
                            ...
                            Email: <a href="mailto:cuisineberg@gmail.com" className="text-blue-600 underline">cuisineberg@gmail.com</a><br />
                            Website: <a href="https://cuisineberg.com" className="text-blue-600 underline">https://cuisineberg.com</a>
                        </p>
                    </section>
